...
$(function() {
    ...
    */
        ...
        */
        ...
        $('#item2 .fadeOut').on('click', function(){
            $('#item2 .target-box').fadeOut(2000)
        })

         //    fadeIn 버튼 클릭 이벤트
         $('#item2 .fadeIn').on('click', function(){
            $('#item2 .target-box').fadeIn(2000)
        })

        //    fadeToggle 버튼 클릭 이벤트
        $('#item2 .fadeToggle').on('click', function(){
           $('#item2 .target-box').stop().fadeToggle(2000)
       })
   ...
   $('#item3 .slideToggle').on('click', function() {
    $('#item3 .target-box').stop().slideToggle(1500, 'linear', ()=> {
        alert('슬라이드 끝')
        })
    })
